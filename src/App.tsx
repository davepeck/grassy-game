...
const GrassyGame = () => {
  useEffect(() => {
    const config: Types.Core.GameConfig = {
      ...
      width: 480 * 2,
      height: 320 * 2,
      parent: "phaser-game-container", // This id will connect Phaser to a specific div
      physics: {
        default: "arcade",
        arcade: {
          gravity: { y: 0, x: 0 },
      ...
      scene: {
        preload: function () {
          ...
          this.load.image(
            "grassTiles",
            "/world/sproutlands/tilesets/Grass.png"
          );
          this.load.image(
            "biomeTiles",
          ...
          this.load.image(
            "hillsTiles",
            "/world/sproutlands/tilesets/Hills.png"
          );
          this.load.image(
            "milkTiles",
          ...
          this.load.image(
            "waterTiles",
            "/world/sproutlands/tilesets/Water.png"
          );
          this.load.image(
            "bridgeTiles",
